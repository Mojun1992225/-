...
//---------------------------------------------
#pragma mark---登录（手机）
-(void)logInWithPhoneNumber:(NSString *)phoneNumber withPassword:(NSString *)password andOther:(id)other  url:(NSString *)url successBlock:(SuccessBlock)successBlock failureBlock:(FailureBlock)failureBlock
{
    ...
    //NSString *urlStr = [url stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
     NSString *urlStr = @"http://192.168.2.106:8080/o2o/service";
