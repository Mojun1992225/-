...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        if (_isFirstView==YES)
        {
            ...
            UIImageView *imageP=[[UIImageView alloc]initWithFrame:CGRectMake(cell.frame.size.width-35, (cell.frame.size.height-30)/2, 35, 30)];
            imageP.image=[UIImage imageNamed:@"bt_04_01_"];
            [cell addSubview:imageP];
            
            cell.textLabel.text=@"原创春夏新款";
