...
-(void)initGirdView
{
    UrlImageView *imageV;   //底图为了描边
        for (int i =0; i<11; i++)
        {
            imageV=[[UrlImageView alloc]initWithFrame:CGRectMake((i%2)*153+13, floor(i/2)*210+10, 140, 140)];
...
//            btn.layer.shadowRadius = 3.0;
            ...
            [btn setBackgroundImage:[UIImage imageNamed:@"banner_02_02"] forState:0];
            [btn addTarget:self action:@selector(btnTouch:) forControlEvents:UIControlEventTouchUpInside];
//            [imageV addSubview:btn];
            [imageV insertSubview:btn aboveSubview:imageV];
            
            UILabel *_label=[[UILabel alloc]initWithFrame:CGRectMake((i%2)*153+13, floor(i/2)*210+10+140, 140, 40)];
...
//            label.text = str;
            ...
            UILabel *title_label=[[UILabel alloc]initWithFrame:CGRectMake((i%2)*153+13, floor(i/2)*210+140+10+_label.frame.size.height, 65, 20)];
...
//
            ...
            UILabel *title_label1=[[UILabel alloc]initWithFrame:CGRectMake((i%2)*153+13+title_label.frame.size.width, floor(i/2)*210+140+10+_label.frame.size.height, 65, 20)];
...
//                     NSLog(@"size.width=%f, size.height=%f", size.width, size.height);
    ...
    [_scrollView setContentSize:CGSizeMake(320, (floor(11/2)+1)*210+30)];
}
#pragma mark红色线条动画
