//
//  TMMyOrderDetailViewController.m
//  TaoMao
//
...
@interface TMMyOrderDetailViewController ()

@end

@implementation TMMyOrderDetailViewController
...
-(void)initFooterView
{
    ...
    [btnLXMJ setImage:BundleImage(@"qcontactbutton.png") forState:0];
