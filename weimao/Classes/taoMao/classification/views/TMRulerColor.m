...
{
//        UIView* bgView = [[UIView alloc]initWithFrame:CGRectMake(0,0, 320,self.frame.size.height-49)];
//        [bgView setTag:99999];
...
//        UIImageView*_imageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, 100)];
...
//        firstLevelMenuView.frame= CGRectMake(0, 150, 320, self.frame.size.height-200);
//    
//    //    [_imageView release];
