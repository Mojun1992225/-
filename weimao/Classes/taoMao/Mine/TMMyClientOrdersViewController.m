//
//  TMMyClientOrdersViewController.m
//  TaoMao
//
...
@interface TMMyClientOrdersViewController ()

@end

@implementation TMMyClientOrdersViewController
...
-(UIView*)initToolBar
{
    ...
    BtnItem1.tag = 100;
    [BtnItem1 setTitle:@"待发货" forState:0];
    ...
    [BtnItem2 setTitle:@"己发货" forState:0];
...
{
    TMMyClientOrdersDetailViewController *VC =[[TMMyClientOrdersDetailViewController alloc]init];
